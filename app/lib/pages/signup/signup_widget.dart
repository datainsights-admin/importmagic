                            ...
                            Expanded(
                              child: Align(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'SIGNUP_PAGE_Text_xe94flli_ON_TAP');
                                  ...
                                  child: GradientText(
                                    FFLocalizations.of(context).getText(
                                      'mixnk07m' /* Are you an existing user? */,
                                    ),
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                setState(() {
                                  ...
                                  FFAppState().pendingImages = [];
                                  FFAppState().uniqueClientId = '';
                                });
                                logFirebaseEvent('Button_backend_call');
                                _model.signUpRes = await AppCall.call(
                                  uniqueClientId: _model.textController2.text,
                                  password: _model.textController3.text,
                                  action: 'create-user',
                                  lang: FFAppState().language,
                                );
                                if ((_model.signUpRes?.succeeded ?? true)) {
                                  logFirebaseEvent('Button_backend_call');
                                  _model.profileRes = await AppCall.call(
                                    token: (_model.signUpRes?.bodyText ?? ''),
